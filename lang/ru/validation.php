...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'Указанное значение поля :attribute было скомпрометировано в утечке данных. Пожалуйста, выберите другое значение поля :attribute.',
    ],
    ...
    /*
    |--------------------------------------------------------------------------
    | Читаемые названия полей
    |--------------------------------------------------------------------------
    |
    | Подменяют технический ключ поля (например "start_at") на понятное
    | человеку название в тексте ошибки. Дополняй по мере появления новых
    | полей, если английское имя поля режет глаз в сообщении на русском.
    */
    'attributes' => [
        'branch_id' => 'филиал',
        'client_id' => 'клиент',
