...
class Chat extends Model
{
    ...
    // участники могут быть из разных точек) не должны пропадать из выборки,
    // как только у пользователя выбрана конкретная точка — BranchScope такие
    // NULL-строки как раз отфильтровал бы. Фильтрация по точке для внешних
