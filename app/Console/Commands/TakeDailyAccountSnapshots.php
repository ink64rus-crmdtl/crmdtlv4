 ...
 * фиксированные "00:00 по серверу", потому что точки одного тенанта могут быть в разных
...
class TakeDailyAccountSnapshots extends Command
{
    ...
    protected $description = 'Посчитать дневные снэпшоты остатков по счетам текущего тенанта, с учетом часового пояса точек';
    ...
    public function handle(): int
    {
        ...
        // Все часовые пояса, реально используемые точками тенанта, плюс пояс тенанта по
        // умолчанию (покрывает счета без точки и точки с незаполненным timezone).
