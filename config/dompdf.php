...
return [
    ...
    */
    ...
    'options' => [
         ...
         * @var string
         */
        // 'serif' (Times-Roman, дефолт пакета) не содержит кириллических глифов
        // вообще — печатные формы для русскоязычного тенанта рендерились бы
        // с "?" вместо текста. DejaVu Sans идёт в комплекте с dompdf и покрывает
        // кириллицу — используем её, если в HTML шаблона явно не задан другой font-family.
