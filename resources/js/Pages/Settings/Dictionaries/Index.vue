...
const activeTab = ref('makes'); // 'makes', 'models', 'import'
        ...
        <div class="w-[99%] mx-auto space-y-6 font-sans text-gray-600 dark:text-gray-400">
            ...
            <div class="bg-white border border-gray-200/80 rounded-md shadow-sm dark:bg-[#313a46] dark:border-gray-700/80 overflow-hidden flex flex-col">
                ...
                <div class="flex space-x-6 border-b border-gray-200 dark:border-gray-700 px-6 bg-gray-50/50 dark:bg-gray-800/50">
                    <button @click="activeTab = 'makes'" :class="[activeTab === 'makes' ? 'border-primary text-primary font-bold border-b-2' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 font-medium border-b-2', 'py-3.5 px-2 text-sm transition-colors focus:outline-none']">
                        Марки автомобилей
                    </button>
                    <button @click="activeTab = 'models'" :class="[activeTab === 'models' ? 'border-primary text-primary font-bold border-b-2' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 font-medium border-b-2', 'py-3.5 px-2 text-sm transition-colors focus:outline-none']">
                        Модели автомобилей
                    </button>
                    <button @click="activeTab = 'import'" :class="[activeTab === 'import' ? 'border-primary text-primary font-bold border-b-2' : 'border-transparent text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 font-medium border-b-2', 'py-3.5 px-2 text-sm transition-colors focus:outline-none']">
                        Импорт из CSV
                    </button>
                </div>
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input v-model="modelForm.body_type" list="body_types_list" type="text" placeholder="Кроссовер" class="block w-full rounded-md border border-gray-200 dark:border-gray-700 bg-transparent py-2 px-3 text-sm text-gray-800 dark:text-gray-200 focus:border-primary focus:ring-0" />
                                <datalist id="body_types_list">
                                    <option v-for="bt in existingBodyTypes" :key="bt" :value="bt"></option>
                                </datalist>
                            ...
                            <div>
                                ...
                                <input v-model="modelForm.category" list="categories_list" type="text" placeholder="Класс 3" class="block w-full rounded-md border border-gray-200 dark:border-gray-700 bg-transparent py-2 px-3 text-sm text-gray-800 dark:text-gray-200 focus:border-primary focus:ring-0" />
