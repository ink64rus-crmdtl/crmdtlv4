...
<template>
    <Modal :show="show && !!item" @close="close" max-width="2xl">
        <div class="border-b border-gray-200 dark:border-gray-700 py-3 px-6 flex justify-between items-center bg-gray-50/50 dark:bg-gray-800/50">
            <div>
                <h3 class="text-base font-semibold text-gray-800 dark:text-gray-200">Настройки материала</h3>
        ...
        <form v-if="item" @submit.prevent="submit" class="flex flex-col">
            <div class="p-6 space-y-5 max-h-[70vh] overflow-y-auto custom-scrollbar">
                <!-- Себестоимость / наценка — справочно -->
                <div v-if="hasMarkup" class="bg-info/10 border border-info/20 rounded-md p-3 flex flex-wrap items-center gap-x-6 gap-y-1 text-xs text-gray-600 dark:text-gray-400">
                ...
                <div v-else-if="item.cost_price === null" class="bg-warning/10 border border-warning/20 rounded-md p-3 text-xs text-gray-600 dark:text-gray-400 flex gap-2">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="flex items-start p-4 border border-gray-200 dark:border-gray-700 rounded-md bg-gray-50/50 dark:bg-gray-800/30">
                    ...
                    <div v-if="hasMarkup" class="flex items-start p-4 border border-gray-200 dark:border-gray-700 rounded-md bg-gray-50/50 dark:bg-gray-800/30">
